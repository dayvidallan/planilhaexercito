...
class Categoria(models.Model):
    nome = models.CharField(_('Situação do Militar *'), unique=True, max_length=100,
    ...
    @property
    def get_absolute_url(self):
        return reverse('categoria_update', args=[str(self.pk)])

    @property
    def get_delete_url(self):
        return reverse('categoria_delete', args=[str(self.pk)])
