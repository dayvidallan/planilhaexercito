...
class CategoriaCreateView(LoginRequiredMixin, StaffRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        messages.success(self.request, 'Categoria cadastrada com sucesso na plataforma!')
        return reverse(self.success_url)
...
class CategoriaUpdateView(LoginRequiredMixin, StaffRequiredMixin, UpdateView):
    ...
    def get_success_url(self):
        messages.success(self.request, 'Dados do Categorias atualizados com sucesso na plataforma!')
        return reverse(self.success_url)
